# Generated by Django 3.0.14 on 2023-06-30 11:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("email", models.EmailField(max_length=150, unique=True)),  # noqa
                ("first_name", models.CharField(max_length=100, null=True)),  # noqa
                ("last_name", models.CharField(max_length=100, null=True)),  # noqa
                ("is_staff", models.BooleanField(default=False)),  # noqa
                ("is_active", models.BooleanField(default=True)),  # noqa
                ("role", models.PositiveSmallIntegerField()),  # noqa
                (
                    "groups",
